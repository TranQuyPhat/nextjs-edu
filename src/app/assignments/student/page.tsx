...
import { NotificationDialog } from "@/components/assignment/notification-dialog"
import type { Assignment, Comment, Notification } from "@/types/assignment"
...
export default function StudentAssignmentsPage() {
  ...
  const handleAddComment = (assignmentId: number, content: string) => {
    const comment = {
      id: Date.now(),
      assignmentId,
      userId: user.id,
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <NotificationDialog notifications={notifications} onMarkAsRead={markNotificationAsRead} />
          </div>
