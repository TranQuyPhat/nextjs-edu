        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Tuần từ {weekDates[0].toLocaleDateString("vi-VN")} đến{" "}
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {schedule.reduce(
                    (total, day) =>
                      total +
                      day.classes.filter((c) => c.type === "lesson").length,
                    0
                  )}
                </div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">
                  {schedule.reduce(
                    (total, day) =>
                      total +
                      day.classes.filter((c) => c.type === "lab").length,
                    0
                  )}
                </div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-red-600">
                  {schedule.reduce(
                    (total, day) =>
                      total +
                      day.classes.filter((c) => c.type === "exam").length,
                    0
                  )}
                </div>
