    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Hệ thống Quản lý Học tập</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Tạo và quản lý lớp học, theo dõi học sinh</CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Giao bài tập, tạo trắc nghiệm và chấm điểm tự động</CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Bình luận, thảo luận và hỗ trợ học tập</CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Theo dõi lịch học và các hoạt động</CardDescription>
            </CardHeader>
          </Card>
