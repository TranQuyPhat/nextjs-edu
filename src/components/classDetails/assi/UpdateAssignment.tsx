    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Cập nhật thông tin cho bài tập {assignment.title}
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              {watchedFile && (
                <p className="text-xs text-gray-500 mt-2">{watchedFile.name}</p>
              )}
              ...
              {!watchedFile && assignment.filePath && (
                <p className="text-xs text-gray-500 mt-2">
                  File hiện tại:{" "}
                  <span className="underline">{assignment.fileName}</span>
                </p>
              )}
            </div>
            <input
